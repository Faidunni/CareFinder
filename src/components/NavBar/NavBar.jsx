...
// (
//   <div className="group">
//     <button className="flex bg-white border-gray-300 border-2 rounded-full px-3 py-2 gap-2 group-hover:text-black">
//       <RxHamburgerMenu className="text-black font-bolder" />
//       <RxAvatar className="text-black font-bolder" />
//     </button>
//   </div>
// )
